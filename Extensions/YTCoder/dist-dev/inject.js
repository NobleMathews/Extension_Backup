...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(132), __webpack_require__(47), __webpack_require__(343).setImmediate))
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return playerPromise; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return watchFlexyPromise; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return ytdAppPromise; });
var resolvePlayer = void 0,
    resolveWatchFlexy = void 0,
    resolveYtdApp = void 0;

var playerPromise = new Promise(function (resolve) {
  return resolvePlayer = resolve;
});
var watchFlexyPromise = new Promise(function (resolve) {
  return resolveWatchFlexy = resolve;
});
var ytdAppPromise = new Promise(function (resolve) {
  return resolveYtdApp = resolve;
});

var resolveElement = function resolveElement(query, resolve) {
  ...
  setTimeout(function () {
    return resolveElement(query, resolve);
  }, 0);
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dom_element_dependencies__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_setup_resizebar_drag__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TabHeadings__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__lib_hide_app_widgets__ = __webpack_require__(354);
...
var App = {
  ...
  beforeCreate: function beforeCreate() {
    Object(__WEBPACK_IMPORTED_MODULE_4__lib_hide_app_widgets__["a" /* default */])(this);
    ...
    window.addEventListener("reset-divider-event", function () {
      ...
      Promise.resolve().then(function () {
        return localStorage.setItem("warc-player-width-percent", appInstance.playerWidthPercent);
      });
    });
  },
  mounted: function mounted() {
    var pwp = localStorage.getItem("warc-player-width-percent");
    this.playerWidthPercent = pwp ? pwp : 0.5;

    this.setPlayerWidth();

    Object(__WEBPACK_IMPORTED_MODULE_2__lib_setup_resizebar_drag__["a" /* default */])(this.$refs.resizeBar, this);
  },
  watch: {
    playerWidth: function playerWidth(_playerWidth) {
      this.appStyles = "\n        <style>\n          #player.ytd-watch-flexy {\n            width: " + _playerWidth + "px;\n          }\n          #primary-inner.ytd-watch-flexy {\n            margin-left: " + (24 + _playerWidth + 24 + 2 + 24) + "px;\n          }\n          #warc-tab-headings {\n            left: " + (24 + _playerWidth + 24 + 2 + 24) + "px;\n          }\n        </style>\n      ";
      __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */].nextTick(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var watchFlexy;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return __WEBPACK_IMPORTED_MODULE_0__dom_element_dependencies__["b" /* watchFlexyPromise */];

              case 2:
                watchFlexy = _context.sent;
  ...
  components: {
    TabHeadings: __WEBPACK_IMPORTED_MODULE_3__TabHeadings__["a" /* default */]
  },
  methods: {
    setPlayerWidth: function setPlayerWidth() {
      this.playerWidth = document.documentElement.clientWidth * this.playerWidthPercent;
...
var TabHeadings = {
  ...
  methods: {
    saveScrollTop: function saveScrollTop() {
  ...
  computed: {
    sidebarStyles: function sidebarStyles() {
      if (this.defaultActive) {
...
/* harmony default export */ __webpack_exports__["a"] = (TabHeadings);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_App_vue__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dom_element_dependencies__ = __webpack_require__(95);
var overridePageJavascript = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var watchFlexy, player;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return __WEBPACK_IMPORTED_MODULE_2__dom_element_dependencies__["b" /* watchFlexyPromise */];

          case 2:
            watchFlexy = _context.sent;
            _context.next = 5;
            return __WEBPACK_IMPORTED_MODULE_2__dom_element_dependencies__["a" /* playerPromise */];
          ...
          case 5:
            ...
            watchFlexy.calculateCurrentPlayerSize_ = function () {
              ...
              var ratio = watchFlexy.videoHeightToWidthRatio_;
  ...
  return function overridePageJavascript() {
...
function appendVueRootElement() {
  ...
  var vueInstance = new __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */]({
    el: elem,
    render: function render(h) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_617ab0be_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(355);
var disposed = false
...
var update = __webpack_require__(134)("c9190daa", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-617ab0be\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-617ab0be\",\"scoped\":false,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue");
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = setupResizebarDrag;
// should i worry about remove listeners, nah

function setupResizebarDrag(resizeBarRef, appInstance) {
  var leftMouseDownPageX = 0;

  resizeBarRef.addEventListener("mousedown", function (e) {
    if (e.which === 1) {
  ...
  document.documentElement.addEventListener("mousemove", function (e) {
    if (appInstance.resizebarDragging) {
      ...
      e.preventDefault();
      var moveDist = e.pageX - leftMouseDownPageX;
  ...
  document.documentElement.addEventListener("mouseup", function (e) {
    if (e.which === 1 && appInstance.resizebarDragging) {
      ...
      appInstance.playerWidthPercent = appInstance.playerWidth / document.documentElement.clientWidth;
  ...
  window.onresize = function (event) {
    ...
    resizeTimer = setTimeout(function () {
      ...
      appInstance.playerWidth = document.documentElement.clientWidth * appInstance.playerWidthPercent;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_TabHeadings_vue__ = __webpack_require__(137);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_07b3c734_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TabHeadings_vue__ = __webpack_require__(353);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-07b3c734"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_TabHeadings_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_07b3c734_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TabHeadings_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/TabHeadings.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-07b3c734", Component.options)
  } else {
    hotAPI.reload("data-v-07b3c734", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(134)("0fd307a2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-07b3c734\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./TabHeadings.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-07b3c734\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./TabHeadings.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\ndiv[data-v-07b3c734] {\n  position: fixed;\n  top: 60px; \n  z-index: 10000;\n}\n#warc-tab-headings[data-v-07b3c734]{\n    background: #2c3e50;\n    border-radius: 0.6em;\n    padding:10px;\n}\n/* button {\n  font-size: 20px;\n  margin: 0px 10px;\n}*/\nbutton.active[data-v-07b3c734] {\n    outline: 0;\n  outline-style: none;\n  -moz-outline-style: none;\n}\nbutton[data-v-07b3c734] {\n    border-color: #f1c40f;\n  color: black;\n  background-position: 100%;\n  background-size: 400%;\n  -webkit-transition: background 300ms ease-in-out;\n  transition: background 300ms ease-in-out;\n  box-sizing: border-box;\n  -webkit-appearance: none;\n     -moz-appearance: none;\n          appearance: none;\n  background-color: transparent;\n  border-radius: 0.6em;\n  cursor: pointer;\n  display: inline-flex;\n  align-self: center;\n    font-size: 1.5rem;\n    padding:5px;\n    font-weight: 400;;\n  text-decoration: none;\n  text-align: center;\n  text-transform: uppercase;\n  font-family: 'Montserrat', sans-serif;\n  font-weight: bolder;\n}\n/* .btn:hover, .btn:focus {\n  color: #fff;\n  outline: 0;\n} */\nbutton[data-v-07b3c734]:hover {\n  background-position: 0;\n}\n", ""]);
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "warc-tab-headings" } }, [
    _c(
      "button",
      { class: { active: _vm.defaultActive }, on: { click: _vm.defaultOpt } },
      [_vm._v("Default Options")]
    ),
    _vm._v(" "),
    _c(
      "button",
      { class: { active: _vm.coderActive }, on: { click: _vm.coder } },
      [_vm._v("YTCoder")]
    ),
    _vm._v(" "),
    _c("div", { domProps: { innerHTML: _vm._s(_vm.sidebarStyles) } })
  ])
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-07b3c734", esExports)
  }
}
...
/* harmony default export */ __webpack_exports__["a"] = ((function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(appInstance) {
    var ytdApp;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return __WEBPACK_IMPORTED_MODULE_0__dom_element_dependencies__["c" /* ytdAppPromise */];

          case 2:
            ytdApp = _context.sent;
  ...
  function hideAppWidgets(_x) {
    return _ref.apply(this, arguments);
  }

  return hideAppWidgets;
})());
  ...
  return _c(
    ...
    [
      _c(
        ...
        {
          ref: "resizeBar",
          class: { hidden: _vm.hideAppWidgets },
          style: _vm.resizebarStyle,
          attrs: { id: "warc-resize-bar" }
        },
        [_c("div")]
      ),
      _vm._v(" "),
      _c("div", { domProps: { innerHTML: _vm._s(_vm.appStyles) } }),
      _vm._v(" "),
      _c("TabHeadings", { class: { hidden: _vm.hideAppWidgets } })
    ],
    1
  )
}
